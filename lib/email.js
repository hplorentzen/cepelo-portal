...
export function dealerQuoteEmail({ dealerName, quoteRef, products, quoteUrl, senderName, senderEmail, senderPhone, notes }) {
  ...
  const dealerShort = formatDealerNameShort(dealerName)
  ...
  const html = emailShell(`
    ...
    <p style="font-size:14px;color:#323232;line-height:1.7;margin:0 0 24px">
      Kære ${dealerShort || dealerName || 'forhandler'},<br><br>
    ...
    <div style="margin-top:28px;padding-top:20px;border-top:1px solid #E0E0E4">
      <p style="font-size:12px;color:#767686;margin:0 0 8px;text-transform:uppercase;letter-spacing:.06em;font-weight:600">Med venlig hilsen</p>
      ...
      <p style="font-size:12px;color:#767686;margin:0 0 6px">CEPELO A/S${dealerShort ? ` &mdash; Kontakt for ${dealerShort}` : ''}</p>
